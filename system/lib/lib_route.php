...
final class Route{
        ...
        public function __construct() {
                $this->url_query = parse_url($_SERVER['REQUEST_URI']);//此函数返回一个关联数组，包含现有 URL 的各种组成部分。      
        }
        /**
         * 设置URL类型
         * @access      public
        ...
        /**
         * 将query形式的URL转化成数组，普通模式index.php?c=controller&a=action&id=2
         * @access      public
         */
        ...
        /**
         * 将PATH_INFO的URL形式转化为数组，路径模式：index.php/controller/action/id/2
         * @access      public
         */
